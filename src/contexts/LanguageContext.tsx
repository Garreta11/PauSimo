...
const translations: Record<Language, Record<string, string>> = {
  en: {
    // Hero Section
    'hero.title': 'Strategic language for storytelling, tech & AI environments',
    ...
    'contact.description': 'If language carries risk, reputation or performance<br/>— let’s get it right.',
  ...
  ca: {
    ...
    'contact.description': 'En el llenguatge estan en joc la reputació i l’impacte.<br/>Per això, l’excel·lència és una obligació.',
  ...
  es: {
    ...
    'hero.description': 'Cuando el matiz es crucial, la lengua es estrategia.',
    ...
    'contact.description': 'En el lenguaje están en juego la reputación y el impacto.<br/>Por eso, la excelencia es una obligación.',
