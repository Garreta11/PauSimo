...
const translations: Record<Language, Record<string, string>> = {
  ...
  ca: {
    // Hero Section
    'hero.subtitle': 'Consultor de Traducció',
    'hero.title': 'Precisió en cada paraula. Impacte en cada missatge.',
    'hero.languages': 'Anglès / Francès',
    'hero.arrow': '→',
    'hero.target': 'Espanyol / Català',
    'hero.tag1': 'Mitjans Audiovisuals',
    'hero.tag2': 'Traducció Cultural',
    'hero.tag3': 'Lingüística Tècnica',
    'hero.description': 'Més de deu anys oferint solucions lingüístiques que connecten cultures, impulsen el rendiment i potencien la tecnologia més avançada.',
    
    // Value Proposition
    'value.subtitle': 'Filosofia',
    'value.title': 'On la Cultura Troba la Tecnologia per Emocionar, Connectar i Actuar',
    'value.problemTitle': 'El Problema',
    'value.problem1': 'Subtítols descuidats',
    'value.problem2': 'Terminologia imprecisa',
    'value.problem3': 'Adaptacions literals',
    'value.result1': 'Maten l\'emoció',
    'value.result2': 'Maten el rendiment',
    'value.result3': 'Maten l\'engagement',
    'value.solutionTitle': 'La Solució',
    'value.solution': 'Transformo el vostre contingut perquè cada missatge arribi amb tota la seva força, ressoni profundament amb les audiències i s\'integri perfectament amb plataformes impulsades per IA i sistemes tècnics.',
    'value.cta': 'Parlem!',
    ...
    'services.heading': 'Què Obtindràs',
    'services.1.title': 'Traducció de Subtítols',
    'services.1.description': 'Sincronització precisa de temps, to i missatge per preservar l\'impacte emocional i el flux narratiu.',
    'services.2.title': 'Accessibilitat Completa',
    'services.2.description': 'Sobretitulació en directe, audiodescripció i subtítols per a persones sordes: garantint contingut inclusiu per a tothom.',
    'services.3.title': 'Doblatge i Veu en Off',
    'services.3.description': 'Adaptació de guions i direcció de veu que capturen cada matís i emoció de forma autèntica.',
    'services.4.title': 'Localització i Transcreació',
    'services.4.description': 'Adaptació cultural, digital i tècnica que manté la veu de marca mentre ressona localment.',
    'services.5.title': 'Enginyeria Lingüística',
    'services.5.description': 'Solucions especialitzades per a lingüística d\'IA, localització de programari, documentació industrial i comunicació tècnica.',
    
    // Partnership
    'partnership.subtitle': 'Enfocament de Col·laboració',
    'partnership.title': 'El Teu Soci Lingüístic Estratègic',
    'partnership.1.title': 'Personalitzat i Integrat',
    'partnership.1.description': 'Integració perfecta en el flux de treball i la cultura del teu equip.',
    'partnership.2.title': 'Qualitat i Impacte',
    'partnership.2.description': 'Resultats impulsats per la precisió que equilibren emoció i exactitud tècnica.',
    'partnership.3.title': 'Flexible i Ràpid',
    'partnership.3.description': 'Adaptació àgil a terminis ajustats i canvis d\'última hora.',
    'partnership.4.title': 'Creatiu i Adaptable',
    'partnership.4.description': 'Solucions innovadores que són tècnicament sòlides i culturalment ressonants.',
    'partnership.portfolioTitle': 'Portafoli Complet de Serveis',
    'partnership.detail1.title': 'Llenguatge per a Pantalla i Narrativa',
    'partnership.detail1.description': 'Guions, pel·lícules, sèries, documentals i contingut de mitjans digitals.',
    'partnership.detail2.title': 'Subtitulació i Accessibilitat',
    'partnership.detail2.description': 'Sobretitulació en directe, subtítols creatius, SPS (subtítols per a persones sordes) i audiodescripcions completes.',
    'partnership.detail3.title': 'Doblatge i Veu en Off',
    'partnership.detail3.description': 'Adaptació de guions, doblatge precís, sincronització labial per a qualsevol format audiovisual.',
    'partnership.detail4.title': 'Transcreació i Adaptació Publicitària',
    'partnership.detail4.description': 'Campanyes de màrqueting, contingut artístic i missatges creatius amb impacte cultural i emocional.',
    'partnership.detail5.title': 'Lingüística Tècnica',
    'partnership.detail5.description': 'Entrenament d\'agents d\'IA, localització de programari, ajust fi d\'IA, interfícies d\'automoció, documentació d\'enginyeria, comunicació del sector energètic.',
    ...
    'contact.title': 'Creem Quelcom Excepcional',
    'contact.description': 'Preparat per elevar el teu contingut amb precisió, intel·ligència cultural i excel·lència tècnica? Parlem de com podem treballar junts.',
